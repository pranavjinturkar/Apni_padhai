    ...
    >
      ...
      <ul className="mt-6 space-y-2">
        <li className="flex items-center gap-1">
          ...
          <span className="text-white"> Access to All Courses </span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-white"> Free Source Code </span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-white"> Free App Membership </span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-white"> Email & Instagram DM support </span>
        </li>
      </ul>
